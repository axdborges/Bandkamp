...
ALLOWED_HOSTS = ["bandkamp-production.up.railway.app", "0.0.0.0"]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Bandkamp',
    'DESCRIPTION': 'This API may be able to register users and create music albums with songs for each user',
    'VERSION': '1.0.0',
